<section class="solutions">
  <div class="solutions-image-container">
    <img class="solutions-image" src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/frontend/public/assets/images/solutions-bg.webp" alt="Solutions bg">
  </div>
      ...
      <div class="card-2-3-container">
        <div class="card-2">
          <div class="card-2-image-container">
            <img class="card-2-image" src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/frontend/public/assets/images/solution-card.webp" alt="Solution card">
          </div>
