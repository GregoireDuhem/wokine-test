  ...
  <div class="products-container">
      ...
      ?>
          <div class="products-card">
            <div class="products-image-container">
              ...
              <?php else : ?>
                <img class="products-image" src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/frontend/public/assets/images/solution-card.webp" alt="Produit">
              <?php endif; ?>
              <?php if ($label) : ?>
            ...
            <div class="products-card-content">
              <h3 class="products-card-title"><?php the_title(); ?></h3>
              <?php if ($description) : ?>
        ...
        <div class="products-card">
          ...
          <div class="products-card-content">
            <h3 class="products-card-title">Vehicula dapibus</h3>
    ...
    <div class="products-arrows">
      <button type="button" class="products-arrow products-arrow-right" aria-label="Suivant">
        <svg class="opacity" fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" stroke="currentColor" stroke-width="5" aria-hidden="true">
          <g>
      ...
      <button type="button" class="products-arrow products-arrow-left" aria-label="Précédent">
        <svg fill="currentColor" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" stroke="#000000" stroke-width="5" transform="matrix(-1, 0, 0, 1, 0, 0)" aria-hidden="true">
